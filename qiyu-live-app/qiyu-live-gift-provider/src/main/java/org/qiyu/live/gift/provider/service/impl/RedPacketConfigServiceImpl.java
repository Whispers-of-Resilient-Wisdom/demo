...
import com.qiyu.live.common.interfaces.utils.ListUtils;
...
//select *from  t_red_packet_config
// where anchorId=#{anchorId} and status=#{status}
...
// order by createTime desc limit 1
    ...
    // 两倍随机发
    // rand=random(1,Left-price/left-people*2);
